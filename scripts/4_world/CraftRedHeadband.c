class CraftRedHeadband extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Dye Red Headband";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"NamantH_Headband_BloodSplatter");	//you can insert multiple ingredients this way
		...
		//RESULTS
		//result1
		AddResult("NamantH_Headband_Red");							// add results here
