class CraftDeepRedHeadband extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Dye Deep Red Headband";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"NamantH_Headband_Red");	//you can insert multiple ingredients this way
		...
		//RESULTS
		//result1
		AddResult("NamantH_Headband_DeepRed");							// add results here
