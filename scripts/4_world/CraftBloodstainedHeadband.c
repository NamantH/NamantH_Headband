class CraftBloodstainedHeadband extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Craft Bloodstained Headband";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"NamantH_Headband_White");	//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"BloodBagFull");
		...
		//RESULTS
		//result1
		AddResult("NamantH_Headband_BloodSplatter");							// add results here
